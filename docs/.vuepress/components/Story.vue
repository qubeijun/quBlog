<template>
  <div class="StyledWrapper">
    <section-title :title="'我们的故事'"> </section-title>
    <div class="tl">
      <ul v-for="(item, index) in items" class="items" :key="index">
        <li :key="item.title" class="item">
          <div class="pic">
          ...
          <div class="content">
            ...
            <time class="date">{{ item.datetime }}</time>
